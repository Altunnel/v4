...
### INSTALL SCRIPT LAMA
<pre><code><apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/altunnel/v4/main/agung.sh && chmod +x agung.sh && ./agung.sh</code><pre>
