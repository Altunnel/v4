...
install_cert() {
    ...
    # install trial 1 day
        https://raw.githubusercontent.com/altunnel/v4/limit/trial
    bash trial
    rm -rf trial
...
<p style="text-align: center;">
    <span style="color: #41A85F; font-size: 26px;"><strong>Agung Tunneling</strong></span>
...
<p style="text-align: center;">
    <span style="font-family: 'Trebuchet MS', Helvetica, sans-serif;">
        <span style="color: #E25041; background-color: #61BD6D;">Jatim</span>
...
setup_perangkat() {
    ...
    wget -O /usr/bin/ws.py "https://raw.githubusercontent.com/Andyyuda/vip/main/limit/ws.py" >/dev/null 2>&1
